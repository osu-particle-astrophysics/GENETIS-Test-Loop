			...
			then
				...
				do
					...
					do
						...
						mv ${d}_${e}_${f}_${g}_${h}_${i}_generationDNA.csv OG
						mv ${d}_${e}_${f}_${g}_${h}_${i}_Parents.csv OG
						mv ${d}_${e}_${f}_${g}_${h}_${i}_fitnessScores.csv OG
						mv ${d}_${e}_${f}_${g}_${h}_${i}_ChiScores.csv OG
					    fi
					...
					mv ${d}_${e}_${f}_${g}_${h}_fitness.png OG
					mv ${d}_${e}_${f}_${g}_${h}_Chi.png OG
