...
for i in range(0, len(r1)):
    R1_fit = (r1[i] - Radius1)**2
    R2_fit = (r2[i] -Radius2)**2
    L1_fit = (l1[i] - Length1)**2
    L2_fit = (l2[i] - Length2)**2
    T1_fit = (t1[i] - Theta1)**2
    T2_fit = (t2[i] - Theta2)**2
    b1_fit = (b1[i] - B_coeff1)**2
    b2_fit = (b2[i] - B_coeff2 )**2 

    Sum = (R1_fit + R2_fit + L1_fit + L2_fit + T1_fit + T2_fit + b1_fit + b2_fit)

    fitness.append(1/(Sum + 1)) 
