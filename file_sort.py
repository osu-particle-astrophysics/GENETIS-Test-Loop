                                                        ...
                                                        if((e == 72 and d == 6 and f == 5 and g == 1) or (e-80)%4 == 0):
                                                                ...
                                                                for h in range(1,11):
                                                                        ...
                                                                        for gens in range(0,51):
                                                                                #print(r, c, t, g)
                                                                                runname= str(d) +'_'+ str(e) +'_'+ str(f) +'_'+ str(g) +'_2_2_6_'+ str(h) +'_'+ str(gens) 
...
with open("Master_gen.csv", 'w') as f:
        f.write("Reproduction, \t Crossover, \t Mutation, \t Sigma, \t Earliest, \t Average (.25), \t Standard Deviation (.25), \t Average (.1), \t Standard Deviation (.1) \n")
        for x in range(0, len(run_name)):
                f.write(str(Reproduction[x])+ ", \t " +str(Crossover[x])+ ", \t "+ str(Mutation[x]) + ", \t " +str(Sigma[x]) + ", \t " + str(earliest_gen[x]) + ", \t " + str(average_gen[x]) + ", \t " + str(sigma_average_gen[x]) +", \t" +str(average_gen2[x]) + ", \t" + str(sigma_average_gen2[x]) + "\n")
