...
for i in range(0, len(r1)):
    R1_fit = 1-abs(Radius1 - r1[i])
    R2_fit = 1-abs(Radius2 - r2[i])
    L1_fit = 1-abs(Length1 - l1[i])
    L2_fit = 1-abs(Length2 - l2[i])
    T1_fit = 1-abs(Theta1 - t1[i])
    T2_fit = 1-abs(Theta2 - t2[i])
    b1_fit = 1-abs(B_coeff1 - b1[i])
    b2_fit = 1-abs(B_coeff2 - b2[i]) 
